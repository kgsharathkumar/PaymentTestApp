package com.sharath.upi.payment.ui
...
import com.sharath.upi.payment.R
import com.sharath.upi.payment.UpiPayment
import com.sharath.upi.payment.adapter.UpiListAdapter
import kotlinx.android.synthetic.main.sharath_upi_payment_upi_bottom_sheet.*
...
class UpiBottomSheet : BottomSheetDialogFragment(),AnkoLogger {
    ...
    override fun getTheme(): Int {
        return R.style.sharath_style_Dialog_BottomSheet
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        return inflater.inflate(R.layout.sharath_upi_payment_upi_bottom_sheet, container, false)
    }
