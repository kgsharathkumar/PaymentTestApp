package com.sharath.upi.payment.adapter
...
import kotlinx.android.synthetic.main.sharath_upi_payment_item_upi_list.view.*
...
class UpiListAdapter : RecyclerView.Adapter<UpiListAdapter.AppViewHolder>() {
    ...
    fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AppViewHolder {
        ...
        val layout = LayoutInflater.from(mContext).inflate(R.layout.sharath_upi_payment_item_upi_list, parent, false)
